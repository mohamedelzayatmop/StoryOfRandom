...
namespace StoryOfRandom.ScriptableObjects
{
    ...
    public class MarkovChainRandom : ScriptableObject, IRandom
    {
        ...
        {
            var Tokens = SampleText.Split(' ', StringSplitOptions.None);
        ...
        private void GenerateText()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                var SplitRandomString = RandomString.Split(' ', StringSplitOptions.RemoveEmptyEntries);
                StartingPoint = SplitRandomString[^1];
            }
        }
